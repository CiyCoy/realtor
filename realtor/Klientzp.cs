...
namespace realtor
{
    ...
    public partial class Klientzp : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(textBox2.Text, out id) == int.TryParse(textBox4.Text, out tel) == int.TryParse(textBox6.Text, out nomer))
            {
                ...
                var addQuery = $"insert into klient_db (id_klient, fio, tel, addres_prop, nomer_pas, data_pojd) values ('{id}','{Fio}', '{tel}','{adres}', '{nomer}', '{data}')";
